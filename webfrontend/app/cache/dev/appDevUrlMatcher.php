    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (preg_match('#^/admin(?P<trailingSlash>[/]{0,1})$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'hsp_admin_homepage')), array (  '_controller' => 'HSP\\AdminBundle\\Controller\\DefaultController::indexAction',));
            }
